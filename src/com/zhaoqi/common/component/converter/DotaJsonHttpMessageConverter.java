package com.zhaoqi.common.component.converter;
    ...
    protected Object readInternal(Class<? extends Object> clazz, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        while(true) {
            ...
            if(bytes == -1) {
                ...
                // base64解码
                return JSON.parseObject(Base64Utils.decode(bytes1), 0, bytes1.length, this.charset.newDecoder(), clazz, new Feature[0]);
            }
